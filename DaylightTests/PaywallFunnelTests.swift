...
final class PaywallFunnelTests: XCTestCase {
    ...
    func testCountsPitchesPerSurfaceAndInTotal() {
        ConversionDiagnostics.recordPitchView(impressionID: "daylight_paywall")
        ConversionDiagnostics.recordPitchView(impressionID: "daylight_paywall")
        ConversionDiagnostics.recordPitchView(impressionID: "daylight_onboarding_trial")
        ...
        XCTAssertEqual(attributes["pitch_last"], "onboarding_trial")
    }
    ...
    func testAttributeKeysStayInsideRevenueCatsLimit() {
        ...
        ConversionDiagnostics.recordPitchView(impressionID: "daylight_\(long)")
