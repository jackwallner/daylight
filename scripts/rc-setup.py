...
EXPECTED_PUBLIC_KEY = "appl_VnhgOrjipNjYfjjdNwZcAaKxBou"

# (store identifier, display name, RC product type, offering package key)
PRODUCTS = (
    ("com.jackwallner.daylight.monthly", "Monthly", "subscription", "$rc_monthly"),
    ("com.jackwallner.daylight.yearly", "Yearly", "subscription", "$rc_annual"),
    ("com.jackwallner.daylight.pro.lifetime", "Lifetime", "one_time", "$rc_lifetime"),
)
...
def ensure_offering(project_id: str) -> dict:
    ...
    offering = request(
        ...
        {"lookup_key": "default", "display_name": "Daylight+", "is_current": True},
    )
