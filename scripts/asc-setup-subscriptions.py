#!/usr/bin/env python3
"""Create Daylight+ subscriptions, trials, localizations, and Vitals PPP prices."""
...
# put "Daylight Plus Monthly" in front of every non-English storefront.
GROUP_REFERENCE_NAME = "Daylight Plus"
GROUP_DISPLAY_NAME = "Daylight+"
SUBS = [
    ("com.jackwallner.daylight.monthly", "Daylight Plus Monthly", "Daylight+ Monthly", "ONE_MONTH", "5.99", "Monthly access to Daylight+."),
    ("com.jackwallner.daylight.yearly", "Daylight Plus Yearly", "Daylight+ Yearly", "ONE_YEAR", "29.99", "Yearly access to Daylight+."),
]
TIERS = {
