#!/usr/bin/env bash
# Bump, archive, and upload Daylight Left to TestFlight.
set -euo pipefail
...
xcodebuild -resolvePackageDependencies -project Daylight.xcodeproj -scheme Daylight

ARCHIVE="$ROOT/build/Daylight.xcarchive"
rm -rf "$ARCHIVE"

echo "==> Archive Release"
xcodebuild -project Daylight.xcodeproj \
  -scheme Daylight \
