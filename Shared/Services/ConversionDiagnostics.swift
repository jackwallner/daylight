...
/// On-device record of how someone met Daylight+ before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.daylight", category: "Conversion")
    ...
    static let suiteName = "group.com.jackwallner.daylight"
    ...
    private static let impressionPrefix = "daylight_"
